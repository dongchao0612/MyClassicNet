...
class VGGNet16(nn.Module):
    ...
    def __init__(self, layer: int = 1 | 3):
        ...
        self.layer3 = nn.Sequential(
            ...
            nn.Conv2d(256, 256, kernel_size=(3, 3), stride=(1, 1), padding=1),
            nn.BatchNorm2d(256), nn.ReLU(inplace=True),
            nn.Conv2d(256, 256, kernel_size=layer, stride=(1, 1), padding=1),
            nn.BatchNorm2d(256), nn.ReLU(inplace=True), nn.MaxPool2d(2, 2))
        self.layer4 = nn.Sequential(
            nn.Conv2d(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=1),
            nn.BatchNorm2d(512), nn.ReLU(inplace=True),
            nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=1),
            nn.BatchNorm2d(512), nn.ReLU(inplace=True),
            nn.Conv2d(512, 512, kernel_size=layer, stride=(1, 1), padding=1),
            nn.BatchNorm2d(512), nn.ReLU(inplace=True), nn.MaxPool2d(2, 2))
        self.layer5 = nn.Sequential(
            nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=1),
            nn.BatchNorm2d(512), nn.ReLU(inplace=True),
...
if __name__ == '__main__':
    # summary(VGGNet11(), (3, 32, 32), device="cpu")
    # summary(VGGNet13(), (3, 32, 32), device="cpu")
    # summary(VGGNet16(), (3, 32, 32), device="cpu")
    summary(VGGNet19(), (3, 32, 32), device="cpu")
